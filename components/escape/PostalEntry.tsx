...
export function PostalEntry({ escape }: { escape: Escape }) {
  return (
    <section id="free-entry-by-post" className="rule-t section">
      <div className="max-w-[40rem]">
        <h2 data-reveal="item" className="display text-balance text-[2rem] md:text-[2.75rem]">Free entry by post.</h2>
