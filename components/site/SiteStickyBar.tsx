...
// strings only. The middle slot is the worst-case odds until entries open, then the
...
export function SiteStickyBar({ escape = hampshire, entriesTaken = 0 }: { escape?: Escape; entriesTaken?: number }) {
  ...
  return <StickyBar prize={prizeLineShort(escape)} middle={middle} review={organisation.review} />;
}
